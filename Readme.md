...
Velocity optimization module | LGPL-3.0 | [here](https://github.com/TUMFTM/velocity_optimization) | Python | Optimization-based velocity planning module considering external parameters (e.g., the friction coefficient or a maximum power limit)
